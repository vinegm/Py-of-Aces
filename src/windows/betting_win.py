...
class BettingWindow(BaseWindow):
    ...
    def __init__(self, game: BlackjackGame, menu_window: str, game_window: str, **kwargs):
    ...
    def draw(self) -> None:
        ...
        try:
            ...
            title = "PY OF ACES - BLACKJACK" + mode_text
        ...
        if is_practice_mode:
            print(self.term.center("Practice Mode: No money lost, tracking total winnings"))
            print()

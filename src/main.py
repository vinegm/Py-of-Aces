...
def run():
    ...
    tui.add_window("betting", BettingWindow, menu_window="menu", game_window="game", game=game_instance)
    tui.add_window("game", GameWindow, menu_window="menu", betting_window="betting", game=game_instance)
